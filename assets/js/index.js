...
fetch('http://localhost:2060/getCourseUrl').then((results)=>{return results.json();}).then((results)=>{
...
// /////////Connect to local server and search for data in database////////////////////////////
fetch('http://localhost:2060/getTeamUrl').then((results)=>{return results.json();}).then((results)=>{
